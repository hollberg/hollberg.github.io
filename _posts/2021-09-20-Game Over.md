...
After scraping play-by-play data for all NFL games from 2016-2020, we have a dataset of 231,575 individual plays. Each <code>playId</code> value is stored as the 9-digit <code>gameId</code> followed by 2-3 additional, always increasing, digits. Therefore, we can identify the last play of every game as the larges (maximum) <code>playId</code> value for any game.  

<code>
&#35 6df_pbp is a dataframe of all play by play data
<br/>&#35 df_pbp.columns -> (playId, gameId, homeWinPercentage, play.homeScore, play.awayScore)
