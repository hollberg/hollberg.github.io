...
So let's look a little closer at just these anomalous come back games. Below is a chart of how many comeback victories we observe for a given "victory proximity" score. 
 <br/>
<img src="/assets/img/plot_img.png" alt="Historgram of comeback victories by losing team's win probability">
 ...
 Viewing a heatmap with a split by home or away team victory shows a strong, implausible concentration of away-team victories in games/plays where the home team achieve close to a 99.% win probability, yet there are no similar home team games. This anomalous pattern 
